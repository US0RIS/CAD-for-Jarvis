...
async def qwen_architecture(text: str) -> dict[str, Any]:
    ...
    system = (
        ...
        "Think across mechanical structure, sensing, actuation, power, compute, connectivity, software, electrical interfaces and signal levels, thermal management, fluid/hydraulic systems, cable/tube routing, manufacturing tolerance, packaging, and safety/failure modes where relevant. "
...
def _planner_system() -> str:
    return (
        ...
        "Allowed operations: add, add_component, replace_component, sync_component, update, transform, mate_components, connect_interfaces, label_electrical_net, disconnect, delete, "
        "add_route, update_route, delete_route, add_feature, delete_feature, split_for_manufacturing, set_design_parameter, delete_design_parameter, add_load, add_constraint, set_requirement, add_bom_item, add_note, code_write, code_delete, code_rename, project_name, settings. "
        ...
        "After splitting, re-run manufacturing, structural/joint, assembly, tolerance, electrical, thermal, fluid, routing, and requirement validation as applicable; never treat alignment sockets as proof that the seam is mechanically adequate. "
        ...
        "Use object_id from existing_assets for existing transforms, connections, routes, and code_write. When credentials or deployment-specific values are unknown, "
