...
async def qwen_architecture(text: str) -> dict[str, Any]:
    ...
    system = (
        ...
        "Think across mechanical structure, sensing, actuation, power, compute, connectivity, software, electrical interfaces and signal levels, thermal management, fluid/hydraulic systems, cable/tube routing, manufacturing tolerance, packaging, and safety where relevant. "
...
def _planner_system() -> str:
    return (
        ...
        "Use this whenever a new part must subsequently be moved, mated, wired, machined, plumbed, or programmed in the same plan. "
        ...
        "Create every solved path explicitly with add_constraint {type:'fluid_link',a_id:'$pump',b_id:'$actuator',resistance_pa_s_m3:2e9}, or use {type:'tube',a_id:'$pump',b_id:'$actuator',length_mm:500,inner_diameter_mm:4,dynamic_viscosity_pa_s:0.001,density_kg_m3:998} for explicit laminar circular-tube Hagen-Poiseuille resistance. "
        ...
        "After splitting, re-run manufacturing, structural/joint, assembly, tolerance, electrical, thermal, fluid, and requirement validation as applicable; never treat alignment sockets as proof that the seam is mechanically adequate. "
