...
def _planner_system() -> str:
    return (
        ...
        "After splitting, re-run manufacturing, structural/joint, assembly, tolerance, electrical, thermal, fluid, routing, safety, and requirement validation as applicable; never treat alignment sockets as proof that the seam is mechanically adequate. "
        ...
        "Use object_id from existing_assets for existing transforms, connections, routes, failure modes, and code_write. When credentials or deployment-specific values are unknown, "
