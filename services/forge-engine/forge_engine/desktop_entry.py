...
install_v610_thermal_field_api(main_v31.app, main_v31.v3.legacy.require_session)

# 6.2 makes purchased-component geometry authoritative-first. Exact manufacturer or
# authorized-distributor B-reps replace family stand-ins when available; render solids
